({
    ...
    CloneFAFV : function(component,event,helper){
        console.log('clone selected record'+component.get('v.currentFVFAID'));
        
        $A.createComponent('c:CloneFAFVCMP', {FAFVRecordId:component.get('v.currentFVFAID')},
                           function(component,status,errormessage){
                                console.log(status+'after creating component '+status);
                              //component.fireToastMessage(component);
